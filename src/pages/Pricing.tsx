...
export default function Pricing() {
  return (
    <div className="flex flex-col gap-8 md:gap-10 lg:gap-12.5 pb-20">
      <Navbar />
      <section
        id="pricing"
        className="flex flex-col items-center gap-6 md:gap-8 lg:gap-10 pt-[7rem] md:pt-[8rem] lg:pt-[9rem] px-4 md:px-6"
      >
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:items-center md:max-w-[776px] lg:max-w-[982px] mx-auto">
          <div className="price-card-reguler flex flex-col h-fit w-full rounded-[20px] p-4 md:p-5 border border-obito-grey gap-4 md:gap-5 bg-white">
            <div className="flex items-center gap-3 md:gap-4">
              <img
                src="/obito/assets/images/icons/award-black-fill.svg"
          ...
          <div className="price-card-reguler flex flex-col h-fit w-full rounded-[20px] p-4 md:p-5 border border-obito-grey gap-4 md:gap-5 bg-white">
            <div className="flex items-center gap-3 md:gap-4">
              <img
                src="/obito/assets/images/icons/buildings-green-fill.svg"
                className="flex w-10 md:w-[60px] shrink-0"
                alt="icon"
              />
              <h2 className="font-bold text-lg md:text-[22px] leading-7 md:leading-[33px]">
      ...
      <section id="testimonials" className="w-full">
        ...
        >
          <div className="slide-container flex gap-5 pl-5 flex-nowrap animate-[slide_20s_linear_infinite]">
            {testimonials.map((testimonial) => (
              <div className="w-[280px] md:w-[320px] lg:w-[359px]">
                <TestimonialCard
                  key={testimonial.id}
