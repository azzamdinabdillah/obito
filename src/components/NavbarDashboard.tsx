...
const userProfile: UserProfile = {
  name: "Tamara Utami",
  role: "Programmer UI",
  avatar: "/obito/assets/images/photos/sami.png",
};
  ...
  const bottomNavItems: BottomNavItem[] = [
    {
      ...
      label: "Courses",
      href: "/course/catalog",
      icon: "/obito/assets/images/icons/note-favorite.svg",
    ...
    },
    {
      ...
      label: "Subscription",
      href: "/subscription",
      icon: "/obito/assets/images/icons/ruler&pen.svg",
        ...
        <div className="container-max-w-1280 container-padding-x flex w-full py-5 items-center justify-between mx-auto">
          <div className="flex items-center gap-4 lg:gap-[50px] w-full md:w-auto justify-between md:justify-start">
            <Link to="/" className="flex shrink-0">
              <img
                src="/obito/assets/images/logos/logo-64.png"
          ...
          <div className="flex items-center gap-5 justify-end">
            <div className="items-center gap-5 hidden md:flex">
              ...
              <a href="#" className="flex shrink-0">
                <img
                  src="/obito/assets/images/icons/category.svg"
                  className="flex shrink-0"
                  alt="icon"
                />
              </a>
              <a href="#" className="flex shrink-0">
                <img
                  src="/obito/assets/images/icons/notification.svg"
                  className="flex shrink-0"
                  alt="icon"
                />
              </a>
